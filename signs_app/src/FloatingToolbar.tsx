...
import { IconCameraPlus, IconMapPinPlus, IconPointer } from "@tabler/icons-react";

export type ToolMode = "browse" | "add-manual" | "place-photo";
...
export default function FloatingToolbar({ mode, onChangeMode, pendingPlacementId }: Props) {
  return (
